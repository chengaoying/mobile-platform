                  ...
                  <td id="submenu0" align="center" valign="middle"><table class="sub_table" align="center" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        <tr class="sub_table_tr">
                          ...
                          <td class="sub_table_td" align="left" height="26"><a href="<%=basePath%>add" target="mainFrame">添加管理员</a></td>
                        </tr>
                        <tr>
                          <td class="sub_table_td" align="center" height="26" width="80"></td>
                          <td class="sub_table_td" align="left" height="26"><a href="<%=basePath%>list?pageNo=1" target="mainFrame">管理员列表</a></td>
                        </tr>
                        <tr>
                          <td class="sub_table_td" align="center" height="26" width="80"></td>
