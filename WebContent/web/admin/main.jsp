...
<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
  ...
  <tr>
	...
	<iframe style="z-index: 4; visibility: inherit; width: 100%; height: 96%;" name="mainFrame" id="mainFrame" marginwidth="16" marginheight="16" src="web/admin/welcome.jsp" frameborder="0" noresize scrolling="yes">
	</iframe>
	</td>
  </tr>
